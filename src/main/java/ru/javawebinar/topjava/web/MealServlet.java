...
public class MealServlet extends HttpServlet {
    ...
    public void init() {
        ...
        mealRestController.create(new Meal(null, LocalDateTime.of(2022, Month.FEBRUARY, 28, 23, 0), "Полдник", 523));
    ...
    protected void doFilter(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        request.setAttribute("meals", MealsUtil.getFilteredDate(mealRestController.getAll(),
                MealsUtil.DEFAULT_CALORIES_PER_DAY, LocalDate.parse(startDate), LocalDate.parse(endDate)));
    }
